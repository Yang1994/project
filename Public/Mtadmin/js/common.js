...
$(function(){
    var topStr = $(".sidebar").scrollTop() + $('.current').offset().top - $(".sidebar").offset().top;
    $('.sidebar').scrollTop(topStr);
...
console.log($(".sidebar").scrollTop() + $('.current').offset().top - $(".sidebar").offset().top);*/
/*$('.sidebar').animate({
     scrollTop: $(".sidebar").scrollTop() + $('.current').offset().top - $(".sidebar").offset().top 
 }, 500);*/

/*点击选项，锁定滚动位置
$('.side-sub-menu li').bind('click', function(e) {
    e.preventDefault();
    $('.side-sub-menu').animate({
        scrollTop: $(".side-sub-menu").scrollTop() + $(this).offset().top - $(".side-sub-menu").offset().top 
    }, 1500);
});*/