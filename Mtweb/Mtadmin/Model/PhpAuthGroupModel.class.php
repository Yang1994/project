 ...
 */
class PhpAuthGroupModel extends Model {
    const TYPE_ADMIN                = 1;                   // 管理员用户组类型标识
    const MEMBER                    = 'php_admin';
    const UCENTER_MEMBER            = 'admin';
    const AUTH_GROUP_ACCESS         = 'php_auth_group_access'; // 关系表表名
    const AUTH_EXTEND               = 'php_auth_extend';       // 动态权限扩展信息表
    const AUTH_GROUP                = 'php_auth_group';        // 用户组表名
